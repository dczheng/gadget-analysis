...
void set_units() {
    ...
    fprintf( LogFilefd,  "%-35s: %g\n", "para.UnitMass_in_g", para.UnitMass_in_g );
    fprintf( LogFilefd,  "%-35s: %g\n", "para.UnitTime_in_s", para.UnitTime_in_s );
    fprintf( LogFilefd,  "%-35s: %g\n", "para.UnitLength_in_cm", para.UnitLength_in_cm );
    fprintf( LogFilefd,  "%-35s: %g\n", "para.UnitDensity_in_cgs", para.UnitDensity_in_cgs );
    fprintf( LogFilefd,  "%-35s: %g\n", "para.UnitEnergy_in_cgs", para.UnitEnergy_in_cgs );
    fprintf( LogFilefd,  "%-35s: %g\n", "para.UnitVelocity_in_cm_per_s", para.UnitVelocity_in_cm_per_s );
    if ( para.MpcFlag != 1 ) {
        para.MpcFlag = 1000;
    }
    fputs( sep_str, LogFilefd );
